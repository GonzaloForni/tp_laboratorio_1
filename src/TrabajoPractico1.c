		...
		do
			{
				...
				switch (opcion) {
				case 1:
					printf("Usted a seleccionado la opcion 1, por favor ingrese la cantidad de kilometros: \n");
					kilometrosIngresados= IngresarFlotante();
					break;
				case 2:
					do
					{
					     printf("1. Presione '1' para ingresar el precio de Aerolineas: \n");
				...
				case 4:
					if (flagCalculos == 0) {
						printf("Error! Para ver los datos primero deben ser calculados en la opcion '3'\n\n");
					}
					else {
						printf("\t=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-\n\n"
